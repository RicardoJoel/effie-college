            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                        ...
                        <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">En caso aún no hayas activado tu cuenta y creado tu contraseña, puedes hacerlo ingresando <a href="{{ url('/activate/'.$code ) }}" style="color:#cbb27c;">aquí</a>.</p>
