            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-right:20px;padding-left:20px;padding-top:10px">
                        <p style="color:#808080;margin:0;padding-bottom:15px;font-size:16px">Les contamos que ya pueden acceder a la información de la marca Entel en la plataforma de Effie College. Asegúrense de revisarla al detalle para que puedan desarrollar el caso perfectamente. No se olviden que la fecha límite para enviar el formulario de participación es el viernes 14 de mayo.</p>
                    </td>
                </tr>
                <tr>
